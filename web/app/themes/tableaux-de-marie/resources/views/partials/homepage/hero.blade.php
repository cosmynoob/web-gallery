<section id="hero" class="w-full max-h-[900px] xl:max-h-none h-screen relative overflow-hidden flex items-center sm:items-start">
    ...
    <div class="title mx-auto z-30 pt-16 pb-32 sm:py-32 xl:py-64 w-full flex items-center justify-center px-8 xl:px-24 mx-auto">
        <h1 class="text-5xl sm:text-6xl text-white font-title text-center leading-tight">Les tableaux de Marie</h1>
    </div>
    ...
    <div class="absolute top-0 left-0 w-full sm:w-1/2 h-screen sm:aspect-square -z-20 sm:-z-10 bg-cover bg-bottom" style="background-image: url(@asset('images/hero-1.png'))"></div>
