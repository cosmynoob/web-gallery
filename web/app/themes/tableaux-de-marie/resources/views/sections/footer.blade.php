<footer>
    ...
    <section id="contact" class="w-full py-32 relative bg-art-darker overflow-hidden">
        <div class="w-full pb-16 flex items-center justify-center">
            <p class="text-3xl text-white font-title">{{get_field("footer_title_contact_me", 2)}}</p>
        </div>
        <div class="mx-auto w-96 flex flex-col justify-center items-center text-center font-sans">
            ...
            <div class="social-links flex gap-10">
                ...
                <a href="{{get_field("footer_facebook", 2)}}" target="_blank" class="block text-white text-2xl pb-6">
                    <svg class="w-12 h-12 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
                        <path
                ...
                @endif
                @if (get_field("footer_instagram", 2))
                <a href="{{get_field("footer_instagram", 2)}}" target="_blank" class="block text-white text-2xl pb-6">
                    <svg class="w-12 h-12 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
                        <path
                ...
                @endif
                @if (get_field("footer_linkedin", 2))
                <a href="{{get_field("footer_linkedin", 2)}}" target="_blank" class="block text-white text-2xl pb-6">
                    <svg class="w-12 h-12 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
                        <path
